...
def Comp_Shop_List():
    Comp_Parts_ListFile = open("D:\Computer Parts List.txt", "r")
    for i in range(0, 13):
...
def Comp_Shop_List1(x):
    Comp_Parts_ListFile = open("D:\Computer Parts List.txt")
...
def Comp_Shop_List3():
    Comp_AdditionParts_File = open("D:\Computer Parts List.txt","r")
...
def discount_determine(Total_BuyAmt4):
    offer_determine = open("Buyer_PurchaseInfo.txt", "r")
    d = len(offer_determine.readlines())

    if d == 8:
        print("Your total price of shopping:"+"  "+"$"+str(Total_BuyAmt4))

    elif d == 11:
        discountTotal = Total_BuyAmt4 * 0.95
        moneySaved = Total_BuyAmt4 - discountTotal
        print("You will get a 5% discount for buying 1 additional item.")
        print("Amount of money saved:"+"  "+"$"+str(moneySaved))
        print("New total price of shopping:"+"  "+"$"+str(discountTotal))

    elif d > 12:
        discountTotal = Total_BuyAmt4 * 0.90
        moneySaved = Total_BuyAmt4 - discountTotal
        print("You will get a 10% discount for buying 2 or more additional items.")
        print("Amount of money saved:" + "  " + "$" + str(moneySaved))
        print("New total price of shopping:" + "  " + "$" + str(discountTotal))


discount_determine(Total_BuyAmt4)
