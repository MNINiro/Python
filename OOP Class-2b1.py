class Employee:
    ...
    @classmethod  # It's a decorator. @classmethod helps to create objects in multiple ways
    def set_raise_amt(cls, rate):  # cls is class variable
        cls.raise_amt = rate  # parameter which will take amount value,i.e 1.05
